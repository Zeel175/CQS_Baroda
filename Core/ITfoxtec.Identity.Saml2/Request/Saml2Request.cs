...
namespace ITfoxtec.Identity.Saml2
{
    ...
    public abstract class Saml2Request
    {
        ...
        protected internal virtual void Read(string xml, bool validateXmlSignature)
        {
            ...
            //XmlElement xmlElement = GetDecriptedAssertion(XmlDocument.DocumentElement, Config.SigningCertificate.PrivateKey);
        ...
        {
            var encryptedList = xmlElement.GetElementsByTagName(EncryptedAssertion.ELEMENT_NAME, dk.nita.saml20.Saml2Constants.ASSERTION);
